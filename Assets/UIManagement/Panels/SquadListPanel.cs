...
namespace UIManagement
{
    public class SquadListPanel : MonoBehaviour, IUIPanel, IDebuggablePanel<SquadListPanel>
    {
        ...
        [SerializeField] private CharacterListElement characterElementPrefab;
        [SerializeField] private List<CharacterListElement> characterList = new List<CharacterListElement>();
