...
namespace CharacterAbility.AbilityEffects
{
    ...
    public class ConditionalBuffAbility : Ability
    {
        ...
        public ConditionalBuffAbility(IBattleObject caster, Ability nextEffect, float probability, Buff_Type buffType,
            ...
            DamageType damageType, bool isMultiplier) :
        ...
        private void InitBuff()
        {
            _buff = _buffType switch
            {
                ...
                Buff_Type.Accuracy => new StatsBuffEffect(Buff_Type.Accuracy, _value, _scaleFromWhom, 9999,
                    _isMultiplier, _caster),
                Buff_Type.Attack => new StatsBuffEffect(Buff_Type.Attack, _value, _scaleFromWhom, 9999, _isMultiplier, _caster),
                Buff_Type.Health => new StatsBuffEffect(Buff_Type.Health, _value, _scaleFromWhom, 9999, _isMultiplier, _caster),
